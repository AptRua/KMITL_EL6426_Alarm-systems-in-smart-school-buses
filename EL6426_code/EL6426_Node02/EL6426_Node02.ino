...
WidgetLED LED2(V2);WidgetLED LED6(V6);WidgetLED LED9(V9);
WidgetLCD LCD1(V15);
...
void setup() 
{
  ...
  Blynk.begin(auth, ssid, pass);LED2.off(); LED6.off(); LED9.off(); LCD1.clear();Blynk.virtualWrite(V12,0);
...
void alert()
{
  ...
  digitalWrite(LED,LOW);
  LCD1.clear();
  LED2.on(); LED6.on(); LED9.on();Blynk.virtualWrite(V12,data);
  delay(500);
  analogWrite(BUZZER,1000);
  digitalWrite(LED,HIGH);
  delay(500);
  LCD1.print(0,0,"SOMEONE IN CAR!");
  LED2.off(); LED6.off(); LED9.off();
...
void read_weigh()
{
  ...
  Serial.print(data);
  Serial.print(" kg  ");
  Blynk.virtualWrite(V12,data); LED6.on();
  Serial.print("\"OBJECT\"");
  ...
  delay(1000);
    ...
    LED6.off(); Blynk.virtualWrite(V12,0);
    Serial.print("Reading: ");
