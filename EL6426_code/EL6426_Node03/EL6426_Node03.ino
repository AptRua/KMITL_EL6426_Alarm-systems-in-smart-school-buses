...
float calibration_factor =47484; 
#define zero_factor -6471
float offset=0.608;
float get_units_kg();
String data;
float weigh;
...
WidgetLED LED3(V3);WidgetLED LED7(V7);WidgetLED LED9(V9);
WidgetLCD LCD1(V15);
...
void setup() 
{
  ...
  Blynk.begin(auth, ssid, pass); LED3.off(); LED7.off(); LED9.off(); LCD1.clear();Blynk.virtualWrite(V13,0);
...
void read_weigh()
{
  ...
  if(weigh>1.00){
    ...
    Serial.print(data);
  Serial.print(" kg  ");
  Blynk.virtualWrite(V13,data);LED7.on();
  Serial.print("\"OBJECT\"");
  ...
  delay(1000);
    ...
    LED7.off(); Blynk.virtualWrite(V13,0);
    Serial.print("Reading: ");
